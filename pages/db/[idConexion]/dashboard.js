...
export async function getStaticProps(ctx) {
    ...
    const infoTables = await axios.post("https://fast-crud.vercel.app/api/fastcrud/showTables", {
        idConexion
    });
    const promises = infoTables.data.tablas.map(async (tabla) => {
        const info = await axios.post("https://fast-crud.vercel.app/api/fastcrud/getTableInfo", {
            idConexion,
            tabla
        });
        return tabla = {
...
export async function getStaticPaths() {
    const { data } = await axios.get("https://fast-crud.vercel.app/api/fastcrud/getAllConections");
